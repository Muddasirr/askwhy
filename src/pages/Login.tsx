...
const Login = () => {
  ...
  return (
  <div className="flex min-h-screen bg-white overflow-y-auto flex-col lg:flex-row">
    {/* Left Side */}
    <div className="flex flex-col justify-start items-start 
      ...
      <div>
        <img src="/logo.svg" className="w-[60%] sm:w-[50%] md:w-[45%] lg:w-[70%] object-contain" />
        <p className="text-[#39154A] font-bold 
          text-[5vw] sm:text-[3.5vw] md:text-[2.5vw] lg:text-[1.5vw] 
          leading-[100%] pt-10 lg:pt-20">
          We are excited to have you here!
        </p>

        <p className="text-[#757888] 
          text-[3.5vw] sm:text-[2.5vw] md:text-[1.8vw] lg:text-[1vw] 
          font-normal leading-[100%] mt-2">
      ...
      <div className="w-full max-w-sm mt-12 space-y-8">
        <div className="space-y-4">
          <div>
            <Label htmlFor="email" className="text-[3.5vw] sm:text-[2.5vw] md:text-[1.8vw] lg:text-[1vw] font-normal text-[#32302E]">
              Enter Email
            </Label>
            <Input
              id="email"
          ...
          <div>
            <Label htmlFor="password" className="text-[3.5vw] sm:text-[2.5vw] md:text-[1.8vw] lg:text-[1vw] font-normal text-[#32302E]">
              Enter Password
            </Label>
            <Input
              id="password"
        ...
        <Button
          className="w-full bg-[#FF8C42] hover:bg-[#ff9f66] 
            flex justify-center items-center 
            text-white text-[4vw] sm:text-[3vw] md:text-[2vw] lg:text-[1.1vw] 
    ...
    {/* Right Side (Hidden on tablet + mobile) */}
    <div className="hidden lg:block w-1/2 py-12 pr-24">
